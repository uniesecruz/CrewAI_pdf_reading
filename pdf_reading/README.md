...
│                         llm_pdf_reading and configuration for tools like black
│
...
│
└── llm_pdf_reading   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes llm_pdf_reading a Python module
    │
